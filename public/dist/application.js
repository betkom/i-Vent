...
var ApplicationConfiguration = function () {
    ...
    var applicationModuleName = 'i-vent';
...
angular.module('likes').controller('LikesController', [
  ...
  function ($scope, $stateParams, $location, Authentication, Likes) {
    ...
    $scope.create = function () {
      ...
      var like = new Likes({ name: this.name });
      // Redirect after save
...
angular.module('likes').factory('Likes', [
  '$resource',
  function ($resource) {
    return $resource('likes/:likeId', { likeId: '@_id' }, { update: { method: 'PUT' } });
  }
]);'use strict';
...
angular.module('programs').config([
  ...
  function ($stateProvider) {
    ...
    $stateProvider.state('listPrograms', {
      url: '/programs',
...
angular.module('programs').controller('ProgramsController', [
  ...
  function ($scope, $stateParams, $location, Authentication, Programs, ProgramsComment, Comments, ProgramsLike, Likes) {
    ...
    //Find existing Program
    $scope.findOne = function () {
      $scope.programContent = Programs.get({ programId: $stateParams.programId }, function (response) {
      ...
      $scope.comments = ProgramsComment.query({ programId: $stateParams.programId });
    };
    $scope.addComments = function () {
      // Create new Comment object
      var comment = new ProgramsComment({ comment: $scope.newComment });
      //Redirect after save
    ...
    $scope.doLike = function () {
      ...
      //Redirect after save
      like.$save({ programId: $stateParams.programId }, function (response) {
...
angular.module('programs').factory('Programs', [
  '$resource',
  function ($resource) {
    return $resource('programs/:programId', { programId: '@_id' }, { update: { method: 'PUT' } });
  }
]);
angular.module('programs').factory('ProgramsComment', [
  '$resource',
  function ($resource) {
...
angular.module('programs').factory('ProgramsLike', [
  '$resource',
  function ($resource) {
...
angular.module('core').factory('Search', [
  ...
  function ($http, $location) {
    ...
    SearchObject.searchEvents = function (obj) {
      SearchObject.searchResults = [];
      $http.get('programs/search', { params: obj }).success(function (response) {
